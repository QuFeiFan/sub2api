export default {
  ...
  admin: {
    ...
    users: {
      ...
      dedicatedAccountHint: 'When set, all API keys of this user will prefer this third-party account without requiring a separate group.',
      ...
      routeChangedSuccess: 'Routing updated successfully',
      routeChangeFailed: 'Failed to update routing',
